    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('hackzilla_ticket')
            ->children()
                ...
                ->scalarNode('event_manager')->cannotBeEmpty()->defaultValue('hackzilla_ticket.event_manager.nothing')->end()
                ->scalarNode('storage_manager')->cannotBeEmpty()->defaultValue('hackzilla_ticket.storage_manager.nothing')->end()
                ->scalarNode('translate_manager')->cannotBeEmpty()->defaultValue('hackzilla_ticket.translate_manager.nothing')->end()
                ->scalarNode('user_manager')->cannotBeEmpty()->defaultValue('hackzilla_ticket.user_manager.nothing')->end()
